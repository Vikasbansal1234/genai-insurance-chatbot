...
const ThreadSuggestions: FC = () => {
  return (
    <div className="aui-thread-welcome-suggestions grid w-full gap-2 pb-4 @md:grid-cols-2">
      {[
        {
          title: "Get all my policies",
          label: "See all my policies",
          action: "Get all my policies",
        },
        {
          title: "Get all Plans",
          label: "See all plans",
          action: "See all plans",
        },
        {
          title: "Show me all active policy",
          label: "See all active policy",
          action: "Show me all active policy",
        },
        {
          title: "Show the cheapest plan",
          label: "See all the cheapest plan",
          action: "Show the cheapest plan",
        },
